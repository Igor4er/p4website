        ...
        <div className="w-1/2 flex items-center justify-center p-4 flex-col relative z-10">
          ...
          <div className="max-w-[min(42rem,80%)] whitespace-break-spaces sm:text-sm lg:text-base">
            ...
            <Magnet padding={140} disabled={false} magnetStrength={35}>
              <div className="mt-2">
                Програмую вже більше чим{" "}
                <span className="font-bold text-rose-400">5 років</span>, з яких{" "}
                <span className="font-bold text-rose-400">1.5 року</span> року
                це комерційна розробка.
              </div>
            </Magnet>
            <Magnet padding={130} disabled={false} magnetStrength={34}>
              <div className="mt-2">
                Активно використовую ШІ для прискорення робочого процесу, однак
                завжди розумію весь код який пишу, і без проблем пишу код без
                жодної допомогти ШІ асистентів.{" "}
                <span className="text-gray-600">
                  Нажаль в наш час мало хто так може((
                </span>
              </div>
            </Magnet>
          </div>
